...
public class SplashActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        configSplash.setBackgroundColor(R.color.colorPurple); //any color you want form colors.xml
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.logosmall); //or any other drawabl
...
//        configSplash.setPathSplashFillColor(R.color.accent_color); //path object filling color
